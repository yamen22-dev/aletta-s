...
<body>
    ...
    <main>
        ...
        <div class="relative outline outline-red-400 h-[80vh] w-screen overflow-x-hidden">
            <svg class="absolute w-[200%] fill-blue-400 h-full -left-3/4" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true" fill="">
                <polygon points="0 40, 100 0, 100 100, 0 70" />
            </svg>
            <section class="relative max-w-7xl mx-auto px-6 md:px-8 py-20">
    ...
    <footer class="relative p-4 bg-white sm:p-6 dark:bg-gray-900 mt-40">
