<hr class="shadow-xl border-gray-200 sm:mx-auto dark:border-gray-700" />
<footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div class="md:flex md:justify-between">
        <div class="mb-6 md:mb-0">
            <div>
                <a href="index.php" class="flex justify-center mt-7 max-sm:mr-40">
                    <img class="mr-19" style="width: 100px" src="img/aletta-logo-small.svg" alt="Logo">
                    <span class="font-semibold text-black text-5xl mt-9 lg:ml-52 max-lg:ml-60 absolute">ARYC</span>
                </a>
            </div>
        </div>
    ...
    <div class="flex justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            <a href="https://nl.linkedin.com/company/ajsph?trk=public_post_feed-actor-name" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg fill="#000000" height="24px" width="24px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 310 310" xml:space="preserve">
                    <g id="XMLID_801_">
            ...
            <a href="https://www.instagram.com/LifelinesNL/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://www.facebook.com/LifelinesNL/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg fill="black" viewBox="0 0 24 24" aria-hidden="true" width="24" height="24">
