...
const buttonClasses = ['uppercase', 'text-sm', 'font-bold', 'tracking-wide', 'text-gray-100', 'p-3', 'rounded-lg', 'w-full', 'focus:outline-none', 'focus:shadow-outline', 'bg-secondarycolor'];
